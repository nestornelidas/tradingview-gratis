...
const ENTRIES: Entry[] = [
  ...
  },
  {
    key: "tunelDomenec",
    group: "Canales",
    label: (c) => `Túnel Domènec (${c.tunelPeriod1}, ${c.tunelPeriod2})`,
  },
  {
    key: "controlTotalDoc",
    group: "Fuerza y Tendencia",
    label: (c) => `Control Total Doc (${c.controlDocPeriod})`,
  },
  {
    key: "multiAvisos",
    group: "Alertas y Señales",
    label: (c) => `Multi-Avisos (${c.multiAvisosPeriod})`,
  },
];
